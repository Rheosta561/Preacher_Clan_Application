...
const Index = () => {
  ...
  const fetchUser = async () => {
    ...
    try {
      const data = await apiFetch<any>(`/user/${user.id}`, {}, logout);
  ...
  return (
    <>
      ...
      >
        ...
        {/* JOIN THE CLAN */}
        <Text className="text-white text-xl font-ScienceGothic mt-4">
          Join The Clan
        </Text>
        ...
        >
          <View className="mr-3">
            <AffiliatePromoCard
              ...
              onPress={() => Linking.openURL("https://www.roguefitness.com")}
            />
          </View>
          ...
          <View className="mr-3">
            <AffiliatePromoCard
              ...
              ctaText="Buy Now"
              onPress={() => Linking.openURL("https://preacherclan.in/store")}
            />
          </View>
        </ScrollView>
