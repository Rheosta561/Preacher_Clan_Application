...
const ExerciseModal = ({ visible, exercise, onClose }: Props) => {
...
{/* video or image placeholder  */}
              ...
              <View className="p-5">
                ...
                <Text className="text-zinc-900 mb-3 font-ScienceGothic leading-5">
                  {exercise?.description ??
                    "A warrior trains with purpose — more details soon."}
                </Text>
                ...
                {exercise?.difficulty && (
                  <Text className="text-sm font-ScienceGothic text-zinc-900 mb-3">
                ...
                <TouchableOpacity
                  onPress={() => {
                    setPlaying(false); // stop video
                    onClose();
                  }}
                  className="bg-black rounded-md py-2"
                >
